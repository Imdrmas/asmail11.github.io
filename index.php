  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
   ...
   <li class="dropdown">
      ...
      <li><a href="https://imdrmas.000webhostapp.com/php.contact/index.php" target="_blank">Contact-me</a></li>
        <li><a href="https://www.docdroid.net/f5MCXqn/deuxcv.pdf">TéléchargerPDF</a></li>
    </ul>
  </div>
</div>
</nav>
   <!-- end navbar mobile -->
    ...
    <div class="collapse navbar-collapse" id="ournavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="https://imdrmas.000webhostapp.com/php.contact/index.php" target="_blank">Contact-me</a></li>
          <li><a href="https://www.docdroid.net/f5MCXqn/deuxcv.pdf" target="_blank">TéléchargerPdf</a></li>
...
<!-- end the container ------------------------------------------------------>
    ...
    <div class="container">
    <h1>Asmail Alfadil <span> Développeur.</span> </h1>
    <p class="lead">J'aime créer et développer des <strong>Sites-Web</strong> </p>
    </div>
     </section>
     <!-- end section aboout -->
    ...
    <!-- start ma journée -->
       <section class="majournee text-center">
         <div class="container">
           ...
           <h2 class="journee" style="font-size:34px; font-weight:bold;">
     ...
     <div class="carousel-inner">
       ...
       <div class="item active">
         <p class="lead">Actuellement en formation à Simplon.co
en développement web Fullstack. <br>
Je recherche un stage à partie de Juin 2017 <br>
Qui me permettrait d'affiner mes compétences
Techniques et mes qualités professionnelles.</p>
        <span>Motivé</span>
       </div>
...
Techniques et mes qualités professionnelles.</p>
     ...
     <ol class="carousel-indicators">
       ...
       <img src="images/propos/php.png" alt="php"></li>
     ...
     <section class="price-table text-center">
       <div class="container">
         ...
         <div class="row">
           ...
           <div class="col-lg-3 col-sm-6 col-xs-12">
             <div class="price-box wow fadeInDown" data-wow-duration="2s" data-wow-offest="200">
              <h3 class="text-danger"> Niveau</h3>
              <p class="center-block"> A1</p>
              <ul class="list-unstyled">
                <li><img class="img-thumbnail"src="images/langue/allmagne.jpg" alt="allmagne"></li>

              </ul>
              <a href="#" class="btn btn-danger disabled">Allemand</a>
             </div>
           </div>
        ...
        <div class="row">
          ...
          <div class="skills-prpgress">
           ...
           <div class="progress">
            ...
            <div class="progress">
            <div class="progress-bar progress-bar-warning progress-bar-striped active" role="progressbar" aria-valuenow="90"
            aria-valuemin="0" aria-valuemax="100" style="width:90%">
            Jquery
            </div>
            </div>
            <div class="progress">
            <div class="progress-bar progress-bar-danger progress-bar-striped active" role="progressbar" aria-valuenow="90"
            aria-valuemin="0" aria-valuemax="100" style="width:90%">
            Php
            </div>
            </div>
          ...
          <div class="col-md-6 col-md-offset-1  hov">
            <div class="skills-info">
              ...
              <p class="lead" style="font-size:18px; font-weight:bold; color: #009AFF;">
               6 mois à temps plein sur le centre de formation  </p>
               <p class="lead" style="font-size:18px; font-weight:bold; color: #009AFF;">
                  Formation à Simplon.co  (développeur web fullstack J.S), </p>
                  <p class="lead" style="font-size: 18px; font-weight:bold; color: #009AFF;">
                     Février 2016 à  août 2017, </p>
                     <p class="lead" style="font-size:18px; font-weight:bold; color: #009AFF;">
                      cette formation est dédiée au développement « front-end » </p>
                        <p class="lead" style="font-size:18px; font-weight:bold; color: #009AFF;">
                          ce qu’on voit à l’écran, avec HTML, CSS, Javascript </p>
                           <p class="lead" style="font-size:18px; font-weight:bold; color: #009AFF;">
                                et ses différents frameworks comme Meteor, React, Bootstrab, </p>
    ...
    <!--  start sectionour logicel -->
     <section class="our-clients">
       <div class="container">
         ...
         <div class="classrow">
           <ul class="list-unstyled">
             <li class="col-md-2 col-xs-4"> <img class="img-responsive center-block wow bounceIn" src="images/logeciel/word.png" alt="word" title="Word" data-wow-duration="1s" data-wow-offest="300" data-wow-delay=".5s"></li>
             <li class="col-md-2 col-xs-4"> <img class="img-responsive center-block wow bounceIn" src="images/logeciel/power.png" alt="powerpoint" title="Powerpoint" data-wow-duration="1s" data-wow-offest="300" data-wow-delay="1s"> </li>
             <li class="col-md-2 col-xs-4"> <img class="img-responsive center-block wow bounceIn" src="images/logeciel/excel.png" alt="video" title="Excel" data-wow-duration="1s" data-wow-offest="300" data-wow-delay="1.5s"> </li>
             <li class="col-md-2 col-xs-4">  <img class="img-responsive center-block wow bounceIn" src="images/logeciel/photo.png" alt="photoshop" title="Photoshop" data-wow-duration="1s" data-wow-offest="300" data-wow-delay="2s"></li>
             <li class="col-md-2 col-xs-4">  <img class="img-responsive center-block wow bounceIn" src="images/logeciel/video.png" alt="éditeurVédio" title="éditeurVédio" data-wow-duration="2.5s" data-wow-offest="300" data-wow-delay="2.5s"></li>
             <li class="col-md-2 col-xs-4"> <img class="img-responsive center-block wow bounceIn" src="images/logeciel/audio.png" alt="audio" title="Audioéditeur" data-wow-duration="1s" data-wow-offest="300" data-wow-delay="3s"></li>
             <li class="col-md-2 col-xs-4"> </li>
           </ul>
         </div>
       </div>
...
<!-- end  Form _________________________________________________-->
 ...
 <p style="font-size:14px; letter-spacing: 2px; "> Copyright &copy; 2017 <span style="font-weight:bold;">ASMAIL AL FADIL</span> Cv en ligne.</p>

 </div>

 <div class="copyright text-center visible-xs-block">
 Copyright &copy; 2017 <span style="font-size:14px;">ASMAIL AL FADIL</span> Cv.
